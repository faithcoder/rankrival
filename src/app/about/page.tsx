...
export const metadata: Metadata = { title: "About", description: "Why RankRival exists and how its transparent product leaderboard works.", alternates: { canonical: "/about" } };
...
export default function AboutPage() {
  ...
  return <article className="mx-auto max-w-4xl py-12 sm:py-16">
    ...
    <section className="mt-14"><h2 className="text-2xl font-bold">A transparent market for attention</h2><p className="mt-4 text-lg leading-8 text-slate-600 dark:text-slate-300">Every listing competes under the same rules. The bid determines the position, older bids win ties, and every outbound click is counted publicly. Listings and rank updates are currently free while payment setup is paused.</p></section>
